        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="py-1 rounded-md text-xs">
            <Input
              ...
              defaultValue={props?.item?.unitName ?? undefined}
              ...
              className={`flex items-center w-full px-2 h-6 py-4 border text-xs border-[#b0afb3] rounded-md focus:outline-none focus:ring-0 focus:border-[#b0afb3] ${
                props.touched.uniCode && props.errors.unitName
                  ? "border-red-500"
                  : "border-[#b0afb3]"
              }`}
            />
        ...
        <div className="py-4 flex justify-end gap-4">
          <div>
            <Button
              ...
              name={"Cancel"}
              className={
                "text-sm text-black bg-white text-center font-[500] py-2 px-4 rounded-md border-[1px] border-black cursor-pointer"
              }
            />
          </div>
          <div>
...
export default withFormik<IFormProps, FormikValues>({
  validationSchema: object().shape({
    ...
    unitName: string().required("Unit name is required"),
    allowDecimal: boolean().required("choose the allow decimal"),
  }),
