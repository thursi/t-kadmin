...
export default function FilterPurchaseForm(props: IFilterFormProps) {
  ...
  const discountTypeOptions = [
    ...
    { name: 'Percentage', label: 'Percentage', value: 'PERCENTAGE' },
  ];
  ...
  return (
    <div className="p-5">
      <div className="flex flex-wrap gap-10">
        ...
        <div className="flex flex-col">
          <label className="mb-0">purchase Date:</label>
          <input
            type="date"
            name="date"
