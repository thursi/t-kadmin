...
//             <img src="/logo.svg" alt="AMU" className="h-8" />
//           </div>
...
//               <h2 className="text-4xl font-medium text-white">Create an account</h2>
...
//               <input type="checkbox" className="rounded border-gray-600 bg-[#2C2C30]" />
...
//                 <span className="px-2 bg-[#1C1C1F] text-gray-400">Or register with</span>
//               </div>
//             </div>
